"""Application-owned sales lines synced from tallydata_sales."""
...
class YoradmSale(Base):
    __tablename__ = "yoradm_sales"
    ...
    item_no: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    ...
    cartage: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
